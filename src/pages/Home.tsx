...
export default function Home() {
  ...
  const mockReviews = [
    { name: "Kareem Tawfik", rank: "Plat VIP Gamer", rate: 5, comment: "ZeroLag is the ultimate spot for Egyptian gamers. Bought FIFA 26 last slots, got my login info within 3 minutes on email! Dynamic support handles everything.", avatar: "KT" },
