...
import { resolveVariantStock } from '../lib/productNormalizer';
...
export default function ProductCard(props: ProductCardProps) {
  ...
  const stockResolution = resolveVariantStock(props, props);
  const isCurrentlyInStock = stockResolution.isAvailable && stockStatus !== 'Out of Stock';
  const totalAvailableStock = stockResolution.stock;
